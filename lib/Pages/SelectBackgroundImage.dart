...
class SelectBackgroundImage extends StatefulWidget {
  @override
  _SelectBackgroundImageState createState() => _SelectBackgroundImageState();
}
...
class _SelectBackgroundImageState extends State<SelectBackgroundImage> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        backgroundColor:  Color(0xff0D0D0D),
        title:  Text('Select background',style: TextStyle(color: Colors.white),),
      ),
      body: Column(
        children: <Widget>[
          Align(
              ...
              child: Padding(
                ...
                child: Text('Select the background image (${images.length}/3).',style: TextStyle(color: Colors.white,fontSize: 16),),
              )),
          Align(
            alignment: Alignment.topLeft,
